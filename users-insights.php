        ...
        curl_setopt_array($curl, array(
          ...
          if ($err) {
            ...
            if (array_key_exists('error',$response)) {
                ...
                $sql1 = "SELECT id FROM page_insights WHERE user_id='".$data['id']."'";
